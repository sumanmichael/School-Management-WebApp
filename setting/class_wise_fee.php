...
<html>
<head>
	<title>Modify Class Fee - SAS</title>
</head>
				...
				<div>
				    <a class="active title item" >
				     ...
				     <div class="active content">
				    	<a href="../setting/class_wise_fee.php" class="active item"><i class="edit icon"></i>Modify Class Fees</a>
	  		...
	  		<div class="ui raised very padded text container segment" style="position: relative; left: -10%; bottom:40%;">
				...
				<div class="ui form success" id="success" style="display: none; border: 3px solid green; position: relative; top: 5px;">
					 <div class="ui success message">
					    <div class="header">Fee List Modified</div>
					    <p>All the class fees will be affeced from now.</p>
					 </div>
				</div>
				...
				<h4 class="ui center aligned header">Please fill all the fields</h4>
				
				<form class="ui form" method="post" action="#" style="left: 30%;">
						<div class="six wide field" > <input type="number" name="nur" placeholder="NUR"></div>
						<div class="six wide field" > <input type="number" name="lkg" placeholder="LKG"></div>
						<div class="six wide field" > <input type="number" name="ukg" placeholder="UKG"></div>
						<div class="six wide field" > <input type="number" name="i" placeholder="I"></div>
						<div class="six wide field" > <input type="number" name="ii" placeholder="II"></div>
						<div class="six wide field" > <input type="number" name="iii" placeholder="III"></div>
						<div class="six wide field" > <input type="number" name="iv" placeholder="IV"></div>
						<div class="six wide field" > <input type="number" name="v" placeholder="V"></div>
						<div class="six wide field" > <input type="number" name="vi" placeholder="VI"></div>
						<div class="six wide field" > <input type="number" name="vii" placeholder="VII"></div>
						<div class="six wide field" > <input type="number" name="viii" placeholder="VIII"></div>
						<div class="six wide field" > <input type="number" name="ix" placeholder="IX"></div>
						<div class="six wide field" > <input type="number" name="x" placeholder="X"></div>
						<button class="ui blue button" style="position: relative; left: 10%;" type="submit" name="submit">MODIFY</button>
				</form>
				...
				<?php 
					if (isset($_POST['submit'])) {
						...
						$ix = $_POST['ix'];
						$x = $_POST['x'];
						$empty_class_fee = "DELETE FROM class_fee";
						$modify_class_fee = "INSERT INTO class_fee (class,fee) VALUES ('ukg','$ukg'), ('lkg','$lkg'), ('nur','$nur'), ('i','$i'),('ii','$ii'), ('iii','$iii'), ('iv','$iv'), ('v','$v'),('vi','$vi'), ('vii','$vii'), ('viii','$viii'), ('ix','$ix'), ('x','$x')";
						$res2 = mysqli_query($con,$empty_class_fee);															
						$res = mysqli_query($con,$modify_class_fee);
						if (!($res && $res2)) {
