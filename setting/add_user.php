	...
	<div class="ui bottom attached segment" >
				...
				<div>
				    <a class="active title item" >
				     ...
				     <div class="active content">
				    	...
				    	<a href="../setting/add_user.php" class="active item"><i class="add user icon"></i>Add User</a>
	  	...
	  	<div class="pusher" style="position: relative;left:-20%; top: 5%; width:150%;" >
	  		<div class="ui raised very padded text container segment" style="position: relative; left: -10%; bottom:40%;">
				...
				<form action="#" class="ui form" method="post" style="position: relative;left:30%">
					<div class="six wide field"><label>Full Name:</label><input type="text" name="fullname"></div>
					<div class="six wide field"><label>Username:</label><input type="text" name="userid"></div>
					<div class="six wide field"><label>Password:</label><input type="text" name="passwd"></div>
					<div class="six wide field"><label>Confirm Password:</label><input type="password" name="passwd2"></div>
					...
					<button class="ui blue button" style="position: relative;left :11%;" type="submit" name="submit"><i class="plus icon"></i> Add</button>
				</form>
				<?php
						include_once("../service/dbcon.php");
						error_reporting(E_ALL & ~E_NOTICE);
						if (isset($_POST['submit'])) {
							...
							if (!strcmp($passwd, $passwd2)) {
								$query = "INSERT INTO users VALUES ('$userid','$passwd','$type','$fullname')";
								$res = mysqli_query($con,$query);
								if(!$res){
									echo '<div class="ui form error" id="notfound" style="position: relative; top: 5px;">
					 <div class="ui error message">
					    <div class="header">Error:</div>
					    <p>Description : "'.mysqli_error($con).'"</p>
					 </div>
				</div>
';
								}
									...
									echo '
									<div class="ui form success" id="success" style="position: relative; top: 5px;">
					 <div class="ui success message">
					    <div class="header">User Added</div>
					    <p>'.$fullname.'is added with userid: '.$userid.'</p>
					 </div>
				</div>';
								}
							}
								...
								echo '<div class="ui form error" id="notfound" style="position: relative; top: 5px;">
					 <div class="ui error message">
					    <div class="header">Passwords Not Matched</div>
					    <p>Please enter identical passwords.</p>
					 </div>
				</div>
';
							}
