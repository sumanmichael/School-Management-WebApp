...
<html>
<head>
	<title>Export Database - SAS</title>
</head>
				...
				<div>
				    <a class="active title item" >
				     ...
				     <div class="active content">
						...
						<a href="../setting/export_db.php" class="active item"><i class="database icon"></i>Export Database</a>
	  	...
	  	<div class="pusher" style="position: relative;left:-20%; top: 5%; width:150%;" >
	  		<div class="ui raised very padded text container segment" style="position: relative; left: -10%; bottom:40%;">
				...
				<div class="ui center aligned container">
					<div>Click 'Export',then click 'Go' in the format section keeping format 'SQL' in the next redirecting page.</div>
				</div>
				<br>
				<div class="ui center aligned container">
					<a href="http://localhost/phpmyadmin/db_export.php?db=erpdb" class="ui blue button">Export</a>
				</div>
