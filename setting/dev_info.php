	...
	<div class="ui bottom attached segment" >
				...
				<div>
				    <a class="active title item" >
				     ...
				     <div class="active content">
				    	...
				    	<a href="../setting/dev_info.php" class="active item"><i class="spy icon"></i>Ask for Help</a>
				    </div>
				</div>
	  	...
	  	<div class="pusher" style="position: relative;left:-20%; top: 5%; width:150%;" >
	  		<div class="ui raised very padded text container segment" style="position: relative; left: -10%; bottom:40%;">
				...
				<div class="ui special cards" id="card" style="position: relative;left: 23%">
	                <div class="card">
	                    <div class="blurring dimmable image">
	                        <div class="ui dimmer">
	                            <div class="content">
	                                <div class="center">
	                                    <a href="http://www.facebook.com/sumanmichael01" class="ui inverted button">Profile</a>
	                                </div>
	                            </div>
	                        </div>
	                        <img src="../media/dev.jpg">
	                    </div>
	                    <div class="content">
	                        <a class="header">Suman Michael</a>
	                        <div class="meta">
	                            <span class="date">Web-Developer</span>
	                        </div>
	                    </div>
	                    <div class="extra content">
	                        <a href="tel:+918500928636">
	                            <i class="phone icon"></i>
	                          	+91 8500 928 636 <br>
	                          	<i class="icon"></i>
	                          	+91 9398 303 147 <br>
	                        </a>
	                        <a href="mailto: sumanmichael01@gmail.com">
	                            <i  class="mail icon"></i>
