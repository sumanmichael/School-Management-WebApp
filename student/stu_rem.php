	...
	<div class="ui bottom attached segment" >
	  		...
	  		<div class="ui styled inverted fluid accordion item">
			    ...
			    <div>
				    ...
				    <div class="active content">
					    ...
					    <a class="active item" href="../student/stu_rem.php">
	  	...
	  	<div class="pusher" style="position: relative;left:-20%; top: 5%; width:150%;" >
	  		<div class="ui raised very padded text container segment" style="position: relative; left: -10%; bottom:40%;">
	  			...
	  			<div class="ui form error" id="success" style="display: none; border: 3px solid red; position: relative; top: 5px;">
					 <div class="ui error message">
					    <div class="header">Admission Removed</div>
					    <p>The following student is removed from the Admission records</p>
					 </div>
				</div>
				...
				<form class="ui form" method="post" action="#">
					...
					<div class="field">
						<button class="ui button" type="submit" name="remove" style="position: relative; left: 42%">Remove</button>
					</div>
					<div class="ui basic modal" >
					  ...
					  <div class="actions">
					    <div class="ui red basic cancel inverted button">
					     ...
					     <a href="../dashboard/" class="ui green basic cancel inverted button">
						...
						<?php
							...
							if (isset($_POST['remove'])) {
								$admn = $_POST['admn'];
								$query = "DELETE FROM stu_data WHERE admn=$admn";
								$query2 = "DELETE FROM stu_fee WHERE admn=$admn";
								$query3 = "DELETE FROM stu_vehi WHERE admn=$admn";
...
if(!isset($_POST['submit']) && !isset($_POST['remove'])) {
	echo '<script type="text/javascript">$(".ui.basic.modal").modal("show"); document.getElementById("fail").innerHTML = "This action will remove the studemt from admission record." ;</script>';
}
?>
