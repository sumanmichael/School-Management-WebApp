	  		...
	  		<div class="ui styled inverted fluid accordion item">
				...
				<div>
				    ...
				    <div class="active content">
				    	...
				    	<a href="../finance/monthly.php" class="active item"><i class="calendar outline icon"></i>Monthly A/c</a>
	  		...
	  		<div class="ui raised very padded text container segment" style="position: relative; left: -10%; bottom:40%;">
				...
				<h2 class="ui center aligned icon header">
					<i class="calendar outline icon"></i>
				  		 Month-wise Financial List
				</h2>
				<form class="ui form" method="post" action="#">
					<div class="fields">
						<div class="four wide field" style="position: relative; left:26%"><label>Year</label><input type="number" name="year" value="<?php echo(date('Y'));?>"></div>
						<div class="three wide field" style="position: relative; left:28%"><label>Month</label><input type="number" name="month" value="<?php echo(date('m'));?>"></div>
					</div>
				...
				<div class="ui segments" style="display: none; " id="table">
					<div class="ui segment">
	                        <h3 class="ui header" style="padding-left:30%">
	                            Month-wise Financial Details - <?php echo $_POST['month'].'-'.$_POST['year']; ?>
	                        </h3>
	                </div>
							...
							<tbody>
								<?php
									...
									if (isset($_POST['show']) || isset($_POST['generate'])) {
										...
										$query = "SELECT * FROM fee_rcpt WHERE YEAR(date_time)=$year AND MONTH(date_time)=$month";
										...
										$query2 = "SELECT COUNT(*) count, sum(amount) sum, round(avg(amount),2) avg FROM fee_rcpt WHERE YEAR(date_time)=$year AND MONTH(date_time)=$month";
