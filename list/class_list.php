	  		...
	  		<div class="ui styled inverted fluid accordion item">
				...
				<div>
				    ...
				    <div class="active content">
				    	<a class="active item" href="../list/class_list.php">
					      <i class="users icon"></i>
					      Class List
					    </a>
	  	...
	  	<div class="pusher" style="position: relative;left:-20%; top: 5%; width:150%;" >
	  		<div class="ui raised very padded text container segment" style="position: relative; left: -10%; bottom:40%;">
				...
				<form class="ui form" method="post" action="#">
					<div class="fields" style="position:relative; left:20%">					
	                	<div class="field" >
	                		<label>Class:</label>
				...
				<div class="ui segments" style="display: none;" id="table">
	                ...
	                <div class="ui segment">
							...
							<tbody>
								<?php
									...
									if (isset($_POST['show']) || isset($_POST['generate'])) {
										...
										$query = "SELECT admn,name,surname,f_name,address FROM stu_data where class = '$class' and section = '$section' order by gender,name";
						...
						<form class="ui form" method="post" action="#">
							<input type="hidden" name="class" value="<?php error_reporting(E_ALL & ~E_NOTICE); echo $_POST['class']; ?>">
							<input type="hidden" name="section" value="<?php error_reporting(E_ALL & ~E_NOTICE); echo $_POST['section']; ?>">
							<div class="fields" >
						  		...
						  		<?php
									...
									if (isset($_POST['generate'])) {
										...
										$query = "SELECT admn,name,surname,f_name,address FROM stu_data where class = '$class' and section = '$section' order by gender,name";
										$res = mysqli_query($con,$query);
										$fname = '../output/ClassList-'.$class.'-'.$section.'-'.date('dMY').'.csv';
