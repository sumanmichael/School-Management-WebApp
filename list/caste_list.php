	  		...
	  		<div class="ui styled inverted fluid accordion item">
				...
				<div>
				    ...
				    <div class="active content">
					    ...
					    <a class="active item" href="../list/caste_list.php">
					      <i class="users icon"></i>
					      Caste List
					    </a>
	  		...
	  		<div class="ui raised very padded text container segment" style="position: relative; left: -10%; bottom:40%;">
				...
				<div class="ui segments" style="display: none;" id="table">
	                ...
	                <div class="ui segment">
							...
							<tbody>
								<?php
									...
									if (isset($_POST['show']) || isset($_POST['generate'])) {
										...
										$query = "SELECT admn,name,surname,f_name,address,class,section,religion FROM stu_data where caste = '$caste' order by class,section,gender,name";
						...
						<form class="ui form" method="post" action="#">
							<input type="hidden" name="caste" value="<?php error_reporting(E_ALL & ~E_NOTICE); echo $_POST['caste']; ?>">
							<div class="fields" >
						  		...
						  		<?php
									...
									if (isset($_POST['generate'])) {
										...
										$query = "SELECT admn,name,surname,f_name,address,class,section FROM stu_data where caste = '$caste' order by class,section,gender,name";
										$fname = '../output/CasteList-'.$caste.'-'.date('dMY').'.csv';
										$res = mysqli_query($con,$query);
										$fp = fopen($fname,'w');
