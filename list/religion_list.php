	  		...
	  		<div class="ui styled inverted fluid accordion item">
				...
				<div>
				    ...
				    <div class="active content">
					    ...
					    <a class="active item"  href="../list/religion_list.php">
					      <i class="users icon"></i>
					       Religion List
					    </a>
	  	...
	  	<div class="pusher" style="position: relative;left:-20%; top: 5%; width:150%;" >
	  		<div class="ui raised very padded text container segment" style="position: relative; left: -10%; bottom:40%;">
				...
				<form class="ui form" method="post" action="#">
					<div class="fields" style="position:relative; left:33.5%">					
	                	<div class="field" >
				...
				<div class="ui segments" style="display: none;" id="table">
					<div class="ui segment">
	                        <h3 class="ui header" style="padding-left:40%">
	                            Student Details
	                        </h3>
	                </div>
	                <div class="ui segment">
							...
							<tbody>
								<?php
									...
									if (isset($_POST['show']) || isset($_POST['generate'])) {
										...
										$query = "SELECT admn,name,surname,f_name,address,class,section FROM stu_data where religion = '$religion' order by class,section,gender,name";
						...
						<form class="ui form" method="post" action="#">
							<input type="hidden" name="religion" value="<?php error_reporting(E_ALL & ~E_NOTICE); echo $_POST['religion']; ?>">
							<div class="fields" >
						  		...
						  		<?php
									...
									if (isset($_POST['generate'])) {
										...
										$query = "SELECT admn,name,surname,f_name,address,class,section,caste FROM stu_data where religion = '$religion' order by class,section,gender,name";
										$fname = '../output/ReligionList-'.$religion.'-'.date('dMY').'.csv';
										$res = mysqli_query($con,$query);
										$fp = fopen($fname,'w');
