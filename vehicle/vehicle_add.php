	  		...
	  		<div class="ui styled inverted fluid accordion item">
				...
				<div>
				    ...
				    <div class="active content">
				    	<a class="active item" href="../vehicle/vehicle_add.php">
					      <i class="add icon"></i>
					      Add Vehicle
					    </a>
	  		...
	  		<div class="ui raised very padded text container segment" style="position: relative; left: -10%; bottom:40%;">
	  			...
	  			<div class="ui form error" id="notfound" style="display: none;">
					 <div class="ui error message">
					    <div class="header">Error in Adding Vehicle</div>
					    <p id="msg"></p>
					 </div>
				</div>
				<div class="ui form success" id="success" style="display: none; border: 3px solid green; position: relative; top: 5px;">
					 <div class="ui success message">
					    ...
					    <p>Serial No.: <?php echo $_POST['sl']; ?> is inserted with Driver -  <?php echo $_POST['driver']; ?></p>
					 </div>
				</div>
				...
				<form class="ui form" method="post" action="#" style="left: 22%">
					<div class="eight wide field">
						  <label>Serial:</label>
						  <input placeholder="Serial Number" name="sl" type="number">
					</div>
				  	<div class="eight wide field">
				  		<label>Driver:</label>
				  	...
				  	<div class="eight wide field">
				  		<label>Driver:</label>
				  		<input type="number" name="driver_phno" placeholder="Phone Number">
				  	</div>	
				  	<div class="eight wide field">
				  	...
				  	<div class="field" >
				  		<button style="position: relative; left:18%" name="add" type="submit" class="ui button"><i class="plus icon"></i>Add</button>
				  	</div>
				</form>
				...
				<?php 
					...
					if (isset($_POST['add'])) {
						$sl = $_POST['sl'];
						$driver = $_POST['driver'];
						$driver_phno = $_POST['driver_phno'];
						$locality = $_POST['locality'];

						$add_vehicle = "INSERT INTO vehi_sl (sl,driver,driver_phno,locality) VALUES ('$sl','$driver','$driver_phno','$locality')";
						$res = mysqli_query($con,$add_vehicle);
						// $error = mysqli_error($con);
						if(!$res){
							echo '<script type="text/javascript">document.getElementById("notfound").style.display="";document.getElementById("msg").innerHTML = "May be an Duplicate entry";</script>';
						}
						else{
