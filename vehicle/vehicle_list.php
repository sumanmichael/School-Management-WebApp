	  		...
	  		<div class="ui styled inverted fluid accordion item">
				...
				<div>
				    ...
				    <div class="active content">
					    ...
					    <a class="active item"  href="../vehicle/vehicle_list.php">
					      <i class="print icon"></i>
					      Vehicles List
					    </a>
				    </div>
	                ...
	                <div class="ui segment">
						<table class="ui definition collapsing table">
							...
							<tbody>
								...
								$query = "SELECT * FROM vehi_sl ORDER BY sl ASC";
							...
							<div class="fields" >
						  		...
						  		<?php
									...
									if (isset($_POST['generate'])) {
										$query = "SELECT * FROM vehi_sl";
										$res = mysqli_query($con,$query);
										$fname = '../output/VehicleDriversList-'.date('dMY').'.csv';
